...
const stripePromise = loadStripe(process.env.NEXT_PUBLIC_STRIPE_SECRET_KEY as string)
...
function Form({priceInCents,productId}:{priceInCents:number,productId:string}){
   ...
   async function handleSubmit(e:FormEvent){
        ...
        if(orderExist){
            setErrorMessage("You have already paurchased this product. Try downloading it from the my order page")
            setIsLoading(false)
            return 
        }
